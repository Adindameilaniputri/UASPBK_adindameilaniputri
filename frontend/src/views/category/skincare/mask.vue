<template>
  <div class="face-makeup">
    <!-- Banner Kategori Mask -->
    <img src="@/assets/bannercleanser.png" alt="Banner Face Mask" class="banner-img" />

    <!-- Judul -->
    <div class="q-pa-md">
      <div class="text-h6 text-pink-6 text-center q-mb-md">Produk Skincare Mask</div>
