<template>
  <div class="face-makeup">
    <!-- Banner Kategori Sunscreen -->
    <img src="@/assets/bannersunscreen.png" alt="Banner Sunscreen" class="banner-img" />

    <!-- Judul -->
    <div class="q-pa-md">
      <div class="text-h6 text-pink-6 text-center q-mb-md">Produk Skincare Sunscreen</div>
