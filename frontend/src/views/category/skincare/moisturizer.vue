<template>
  <div class="face-makeup">
    <!-- Banner Kategori Moisturizer -->
    <img src="@/assets/bannermoisturizer.png" alt="Banner Face Moisturizer" class="banner-img" />

    <!-- Judul -->
    <div class="q-pa-md">
      <div class="text-h6 text-pink-6 text-center q-mb-md">Produk Skincare Moisturizer</div>
