<template>
  <div class="all-makeup q-pa-md">
    <!-- Banner -->
    <img src="@/assets/11.png" alt="All Makeup Banner" class="banner-img" />

    <!-- Judul Halaman -->
    <div class="text-h5 text-center text-pink-6 q-mt-md q-mb-xl">Semua Produk Makeup</div>
...
const categories = ['Face', 'Lip', 'Eye']

const filteredProducts = (category) => {
  return makeupStore.allProducts.filter(product => product.category === category)
}
